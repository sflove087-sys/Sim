...
const WalletCard: React.FC = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-indigo-500 via-violet-500 to-purple-500 text-white p-6 rounded-2xl shadow-lg overflow-hidden flex items-center justify-between">
